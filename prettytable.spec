...
Source0  : https://files.pythonhosted.org/packages/ea/36/a96f1d0f434e1658b3fde011df028efdc3d38bde563339f0fc9e8beadc59/prettytable-2.4.0.tar.gz
...
%prep
%setup -q -n prettytable-2.4.0
cd %{_builddir}/prettytable-2.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636413251
...
cp %{_builddir}/prettytable-2.4.0/COPYING %{buildroot}/usr/share/package-licenses/prettytable/5c51c5dac61ba4be822af5e4dbfbdc9aaac1a2b1
