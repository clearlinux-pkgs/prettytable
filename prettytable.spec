...
%prep
%setup -q -n prettytable-2.2.1
cd %{_builddir}/prettytable-2.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632867196
...
cp %{_builddir}/prettytable-2.2.1/COPYING %{buildroot}/usr/share/package-licenses/prettytable/5c51c5dac61ba4be822af5e4dbfbdc9aaac1a2b1
