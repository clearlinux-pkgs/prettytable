...
%prep
%setup -q -n prettytable-2.2.0
cd %{_builddir}/prettytable-2.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630085910
...
cp %{_builddir}/prettytable-2.2.0/COPYING %{buildroot}/usr/share/package-licenses/prettytable/5c51c5dac61ba4be822af5e4dbfbdc9aaac1a2b1
